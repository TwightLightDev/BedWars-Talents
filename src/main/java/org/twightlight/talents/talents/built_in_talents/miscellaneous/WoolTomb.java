...
public class WoolTomb implements Talent<Void> {
    private final TalentsCategory category;
    private final List<Integer> costList;

    public WoolTomb(TalentsCategory category, List<Integer> costList) {
    ...
    public Void handle(int level, List<Object> params) {
        ...
        ItemStack i = new ItemStack(Material.WOOL, level * 2, ConversionUtil.getDataValue(color));
