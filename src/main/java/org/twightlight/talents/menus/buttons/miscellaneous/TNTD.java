...
public class TNTD {
    ...
    public TNTD() {
        Button button = new Button((e) -> {
            ...
            if (database.getTalentLevel(p, TalentsCategory.Miscellaneous, "FBD") < 10) {
            ...
            lore.add("&7Tăng sát thương TNT thêm " + Utility.toDecimal(level*2.5) + "%.");
            ...
            return ConversionUtil.createItem(Material.TNT, level, "",
                    0, "&eBomman" + roman,
                    lore,
                    enchanted);
        });
