...
public class TH {
    ...
    public TH() {
        Button button = new Button((e) -> {
            ...
            if (database.getTalentLevel(p, TalentsCategory.Melee, "CD") < 10) {
            ...
            lore.add("&7Gây 2 điểm ST chuẩn lên mục tiêu với tỷ lệ " + Utility.toDecimal(level*1.5) +"%");
            lore.add("&7và hồi trực tiếp cho bản thân 1 máu.");
            ...
            if (Talents.getInstance().getDatabase().getTalentLevel(player, TalentsCategory.Melee, "CD") < 10) {
                if (first) {
                    lore.add("");
                    lore.add("&cYêu cầu:");
                    first = false;
            ...
            return ConversionUtil.createItem(Material.SKULL_ITEM, level, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWYwNWExMzg1MzczNGI2YTdlNGY0NWVhYjcyYmI5ZGJjYzkxN2U3ODBjZDFlYjZkNjMwNDA1ZmE4Mjk5NjY1In19fQ==",
                    3, "&eThần zú" + roman,
                    lore,
                    enchanted);
        });
