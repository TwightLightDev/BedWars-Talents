...
public class MAS {
    ...
    public MAS() {
        Button button = new Button((e) -> {
            ...
            lore.add("&7Cận chiến có tỷ lệ " + Utility.toDecimal(level*4) + "% được giảm 35%.");
            ...
            return ConversionUtil.createItem(Material.SHEARS, level, "",
                    0, "&eTấn công nhanh" + roman,
                    lore,
                    enchanted);
        });
