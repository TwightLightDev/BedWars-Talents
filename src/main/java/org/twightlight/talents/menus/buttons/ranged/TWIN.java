...
public class TWIN {
    private int x = -3;
    private int y = 22;
    private TalentsCategory category = TalentsCategory.Ranged;
    private String id = "TWIN";
    ...
    public TWIN() {
        Button button = new Button((e) -> {
            ...
            if (database.getTalentLevel(p, TalentsCategory.Ranged, "CD") < 10) {
            ...
            lore.add("&7Khi bắn 1 mũi tên, bắn thêm 1 mũi tên có sát thương");
            lore.add("&7bằng " + Utility.toDecimal(level * 1.5) + "% mũi tên ban đầu.");
            ...
            if (Talents.getInstance().getDatabase().getTalentLevel(player, TalentsCategory.Ranged, "CD") < 10) {
                if (first) {
                    lore.add("");
                    lore.add("&cYêu cầu:");
                    first = false;
                }
                lore.add("&cSát thương chí mạng X");
                req = false;
            }
            ...
            return ConversionUtil.createItem(Material.SKULL_ITEM, level, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMTg0ODlkYWZjOTVmMjU1NGNlYjM3NDkzODJmNGY5NDNhNWUwMzUyMzgzMjgxNzAyMWM5YTY4NDVlNGE0NDk5YiJ9fX0=",
                    3, "&eSong tiễn" + roman,
                    lore,
                    enchanted);
        });
