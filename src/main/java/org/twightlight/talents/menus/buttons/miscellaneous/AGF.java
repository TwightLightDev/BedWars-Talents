...
public class AGF {
    ...
    public AGF() {
        Button button = new Button((e) -> {
            ...
            lore.add("&7Khi hồi sinh, nhận được " + Utility.toDecimal(level) + " thỏi sắt và "+ Utility.toDecimal(1 + Math.round(level / 10)) + " thỏi vàng.");
            if (level <= 0) {
                lore.clear();
                lore.add("&7Khi hồi sinh, nhận được thỏi vàng và thỏi sắt.");
            ...
            return ConversionUtil.createItem(Material.FURNACE, level, "",
                    0, "&eMạnh thường quân" + roman,
                    lore,
                    enchanted);
        });
