...
public class MHP {
    ...
    public MHP() {
        Button button = new Button((e) -> {
            ...
            if (e.isLeftClick()) {
                ...
                if (soulstones >= Utility.totalCost(costlist, level, level)) {
                    ...
                    if (PlayerMenu.getInstance(p) != null) {
                        ...
                        menu.getHolder().refreshSlot(e.getRawSlot());
                        menu.getHolder().refreshSlot(4);
                    }
                } else {
            ...
            lore.add("&7Tăng máu tối đa thêm " + Utility.toDecimal(level*0.25) + "HP.");
