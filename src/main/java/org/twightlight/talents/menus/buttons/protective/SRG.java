...
public class SRG {
    ...
    public SRG() {
        Button button = new Button((e) -> {
            ...
            lore.add("&7Tăng " + Utility.toDecimal(level*2) + "% khả năng tự phục hồi.");
            ...
            return ConversionUtil.createItem(Material.BREAD, level, "",
                    0, "&eTự hồi phục" + roman,
                    lore,
                    enchanted);
        });
