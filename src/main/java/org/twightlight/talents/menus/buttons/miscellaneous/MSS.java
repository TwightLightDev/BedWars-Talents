...
public class MSS {
    ...
    public MSS() {
        Button button = new Button((e) -> {
            ...
            lore.add("&7Chiến thắng trận đấu sẽ nhận được thêm " + Utility.toDecimal(level) + " soulstones.");
            ...
            return ConversionUtil.createItem(Material.STAINED_CLAY, level, "",
                    ConversionUtil.getDataValue(DyeColor.MAGENTA), "&eChơi đá" + roman,
                    lore,
                    enchanted);
        });
