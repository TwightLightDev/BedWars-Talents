    ...
    public IRS() {
        Button button = new Button((e) -> {
            ...
            if (database.getTalentLevel(p, TalentsCategory.Miscellaneous, "MSS") < 10 ||
                    database.getTalentLevel(p, TalentsCategory.Protective, "GNT") < 10 ) {
            ...
            lore.add("&7Khi bị kết liễu, có xác suất " + Utility.toDecimal(level*3) + "% hồi sinh ngay lập tức.");
            ...
            return ConversionUtil.createItem(Material.GHAST_TEAR, level, "",
                    0, "&eHồi sinh nhanh" + roman,
                    lore,
                    enchanted);
        });
