...
public class Sharpness extends Talent {

    public Sharpness(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.MELEE_PENETRATION_RATIO.name()).add(level * 0.5);
        });
    }
