...
public class Feather extends Talent {
    public Feather(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.FALL_DAMAGE_REDUCTION.name()).add(level * 2.5);
        });
    }
}
