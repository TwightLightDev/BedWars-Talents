...
public class EnchantedSoul extends Talent {
    public EnchantedSoul(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer("ADDITIONAL_ATTACK_DAMAGE").add(level * 0.5);
        });
    }
}
