...
public class Ares extends Talent {

    public Ares(String talentId, List<Integer> costList) {
    ...
    public void onPlayerKill(PlayerKillEvent e) {
        ...
        if (kills <= 5) {
            ...
            statsMap.getStatContainer(BaseStats.GENERIC_ADDITIONAL_DAMAGE.name()).add(add);
