...
public class StrongBoom extends Talent {

    public StrongBoom(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.CRITICAL_DAMAGE.name()).add(level * 2.5);
        });
    }
