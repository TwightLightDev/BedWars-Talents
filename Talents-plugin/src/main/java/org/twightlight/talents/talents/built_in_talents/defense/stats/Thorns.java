...
public class Thorns extends Talent {
    public Thorns(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.LIFESTEAL_REDUCTION.name()).add(level * 2);
        });
    }
}
