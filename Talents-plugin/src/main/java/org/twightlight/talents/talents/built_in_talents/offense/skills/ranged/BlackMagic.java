...
public class BlackMagic extends Talent {

    public BlackMagic(String talentId, List<Integer> costList) {
    ...
    public void onProjectileDamage(RangedDamageEvent e) {
        ...
        if (e.getDamagePacket().containsMetadata("summoner-activated") && Utility.rollChance(level * 4.25)) {
