...
public class Toughness extends Talent {
    public Toughness(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.DAMAGE_REDUCTION.name()).add(level);
        });
    }
}
