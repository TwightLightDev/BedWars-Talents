...
public class BloodyBlade extends Talent {

    public BloodyBlade(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.MELEE_LIFESTEAL.name()).add(level * 0.5);
        });
    }
