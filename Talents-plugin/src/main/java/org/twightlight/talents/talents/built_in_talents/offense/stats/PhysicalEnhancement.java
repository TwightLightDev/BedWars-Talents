package org.twightlight.talents.talents.built_in_talents.offense.stats;
...
public class PhysicalEnhancement extends Talent {

    public PhysicalEnhancement(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.MELEE_DAMAGE.name()).add(level * 0.05);
            map.getStatContainer(BaseStats.RANGED_DAMAGE.name()).add(level * 0.05);
        });
    }
