...
public class Tenacity extends Talent {
    public Tenacity(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.CRITICAL_DAMAGE_REDUCTION.name()).add(level * 2);
        });
    }
}
