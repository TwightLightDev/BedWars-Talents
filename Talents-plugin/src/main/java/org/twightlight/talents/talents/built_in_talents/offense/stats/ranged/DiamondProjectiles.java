...
public class DiamondProjectiles extends Talent {

    public DiamondProjectiles(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.RANGED_PENETRATION_RATIO.name()).add(level * 0.5);
        });
    }
