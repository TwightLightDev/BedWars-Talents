...
public class CharmingProjectiles extends Talent {

    public CharmingProjectiles(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.RANGED_LIFESTEAL.name()).add(level * 0.5);
        });
    }
