...
public class LifeSteal extends Talent {

    public LifeSteal(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.LIFESTEAL.name()).add(level * 0.75);
        });
    }
