package org.twightlight.talents.talents.built_in_talents.offense.stats.melee;
...
public class AttackWeaknesses extends Talent {

    public AttackWeaknesses(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.MELEE_CRITICAL_RATE.name()).add(level);
        });
    }
