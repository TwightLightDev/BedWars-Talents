...
public class Improvement extends Talent {

    public Improvement(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.INCREASE_DAMAGE.name()).add(level * 0.5);
        });
    }
