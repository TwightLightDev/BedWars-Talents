...
public class BandAid extends Talent {
    public BandAid(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.GENERIC_ADDITIONAL_REGENERATION_RATIO.name()).add(level);
        });
    }
}
