...
public class Thump extends Talent {

    public Thump(String talentId, List<Integer> costList) {
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.INCREASE_MELEE_DAMAGE.name()).add(level * 0.5);
        });
    }
