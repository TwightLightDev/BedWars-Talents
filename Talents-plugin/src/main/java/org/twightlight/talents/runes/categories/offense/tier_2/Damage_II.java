...
public class Damage_II extends OffenseRune {

    double primaryValue = 2.1;

    public Damage_II(int tier) {
        super(tier);
    }
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.INCREASE_DAMAGE.name()).add(amount * primaryValue);
        });
    }
}
