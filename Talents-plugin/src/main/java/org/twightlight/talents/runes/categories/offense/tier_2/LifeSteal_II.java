...
public class LifeSteal_II extends OffenseRune {

    double primaryValue = 4.7;

    public LifeSteal_II(int tier) {
        super(tier);
    }
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.LIFESTEAL.name()).add(amount * primaryValue);
        });
    }
}
