package org.twightlight.talents.runes.categories.defense.tier_3;
...
public class Heal_III extends DefenseRune {

    double primaryValue = 3.5;

    public Heal_III(int tier) {
        super(tier);
    }
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.GENERIC_ADDITIONAL_REGENERATION_RATIO.name()).add(amount * primaryValue);
        });
    }
}
