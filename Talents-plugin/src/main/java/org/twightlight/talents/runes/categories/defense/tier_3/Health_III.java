...
public class Health_III extends DefenseRune {

    double primaryValue = 0.65;

    public Health_III(int tier) {
        super(tier);
    }
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.GENERIC_ADDITIONAL_MAX_HEALTH.name()).add(amount * primaryValue);
        });
    }
}
