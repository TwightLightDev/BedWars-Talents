...
public class Armor_III extends DefenseRune {

    double primaryValue = 7;

    public Armor_III(int tier) {
        super(tier);
    }
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.GENERIC_ADDITIONAL_ARMOR.name()).add(amount * primaryValue);
        });
    }
}
