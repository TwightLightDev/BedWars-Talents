...
public class Tenacity_III extends DefenseRune {

    double primaryValue = 6;

    public Tenacity_III(int tier) {
        super(tier);
    }
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.CRITICAL_DAMAGE_REDUCTION.name()).add(amount * primaryValue);
        });
    }
}
