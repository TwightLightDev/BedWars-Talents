package org.twightlight.talents.runes.categories.offense.tier_5;
...
public class Enchantment_Breaker_V extends OffenseRune {

    double primaryValue = 8;

    public Enchantment_Breaker_V(int tier) {
        super(tier);
    }
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.ENCHANTMENT_BREAK_RATIO.name()).add(amount * primaryValue);
        });
    }
}
