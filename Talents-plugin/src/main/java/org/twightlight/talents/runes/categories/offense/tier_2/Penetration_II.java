package org.twightlight.talents.runes.categories.offense.tier_2;
...
public class Penetration_II extends OffenseRune {

    double primaryValue = 4.4;

    public Penetration_II(int tier) {
        super(tier);
    }
    ...
    public void onGameStateChange(GameStateChangeEvent e) {
        ...
        e.getArena().getPlayers().forEach((p) -> {
            ...
            map.getStatContainer(BaseStats.PENETRATION_RATIO.name()).add(amount * primaryValue);
        });
    }
}
